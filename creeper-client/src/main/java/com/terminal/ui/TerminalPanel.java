...
import com.terminal.model.TerminalModelListener;
...
public class TerminalPanel extends JComponent implements TerminalDisplay, ClipboardOwner, TerminalActionProvider {
    ...
    public void init() {
        ...
        addMouseMotionListener(new MouseMotionAdapter() {
            ...
            public void mouseDragged(final MouseEvent e) {
                ...
                if (mySelection == null) {
                    // prevent unlikely case where drag started outside com.terminal panel
            ...
            if (terminalPanel != null) {
                ...
                if (terminalPanel.needRepaint.getAndSet(false)) {
                    try {
                        ...
                        LOG.error("Error while com.terminal panel redraw", ex);
                    }
                }
    ...
    /**
     * Draw every char in separate com.terminal cell to guaranty equal width for different lines.
