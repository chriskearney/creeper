...
public class AccuweatherManager {
    ...
    public AccuweatherReport getCurrentConditions(String searchString) {
        ...
        return new AccuweatherReport(weatherText, temperature, humidity, feelslike, windDirectionEnglish + " " + windDirectionSpeed + " " + windDirectionUnit);
    }
    ...
    public static class AccuweatherReport {
        ...
        public AccuweatherReport(String weatherDescription, String temperature, String humidity, String feelsLike, String wind) {
        ...
        public String toString() {
            return weatherDescription + " | Temperature: " + temperature + " | Humidity: " + humidity + " | Feels Like: " + feelsLike + " | Wind: " + wind;
        }
    }
}
