...
import com.terminal.TerminalKeyEncoder;
...
import com.terminal.emulator.mouse.MouseButtonCodes;
import com.terminal.emulator.mouse.MouseButtonModifierFlags;
    ...
    if (shouldSendMouseData(MouseMode.MOUSE_REPORTING_NORMAL, MouseMode.MOUSE_REPORTING_BUTTON_MOTION)) {
      ...
      if (cb != MouseButtonCodes.NONE) {
        if (cb == MouseButtonCodes.SCROLLDOWN || cb == MouseButtonCodes.SCROLLUP) {
          // convert x11 scroll button number to com.terminal button code
