...
import com.terminal.DataStreamIteratingEmulator;
...
import com.terminal.TerminalOutputStream;
...
/**
 * The main com.terminal emulator class.
 * <p/>
 * Obtains data from the  {@link com.jediterm.terminal.TerminalDataStream}, interprets com.terminal ANSI escape sequences as commands and directs them
...
public class JediEmulator extends DataStreamIteratingEmulator {
    ...
    private final java.util.List<NonControlCharListener> nonControlCharactersListeners;
    ...
    public JediEmulator(TerminalDataStream dataStream, TerminalOutputStream outputStream, Terminal terminal) {
        ...
        this.nonControlCharactersListeners = Lists.newArrayList();
    }
    ...
    public JediEmulator(TerminalDataStream dataStream, Terminal terminal, java.util.List<NonControlCharListener> nonControlCharListeners) {
        super(dataStream, terminal);
        this.nonControlCharactersListeners = nonControlCharListeners;
    }
    ...
    public void processChar(char ch, Terminal terminal) throws IOException {
        switch (ch) {
            ...
            case Ascii.CR: //Carriage return (Ctrl-M)
                ...
                break;
            case Ascii.ENQ: //Return com.terminal status (Ctrl-E). Default response is an empty string
            ...
            default:
                if (ch <= Ascii.US) {
                    ...
                    for (NonControlCharListener nonControlCharListener: nonControlCharactersListeners) {
                        nonControlCharListener.processNonControlChar(nonControlCharacters);
                    }
...
//        height or width.
    ...
    public interface NonControlCharListener {
        void processNonControlChar(String nonControlCharacters);
    }
}
