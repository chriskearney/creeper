...
import terminal.StyledTextConsumer;
...
import terminal.emulator.charset.CharacterSets;
import terminal.emulator.mouse.MouseMode;
import terminal.emulator.mouse.TerminalMouseListener;
import terminal.model.CharBuffer;
import terminal.model.JediTerminal;
import terminal.model.LinesBuffer;
import terminal.model.SelectionUtil;
import terminal.model.StyleState;
import terminal.model.TerminalLine;
import terminal.model.TerminalModelListener;
...
public class TerminalPanel extends JComponent implements TerminalDisplay, ClipboardOwner, TerminalActionProvider {
    ...
    public TerminalStarter getMyTerminalStarter() {
    ...
    private TextStyle getInversedStyle(TextStyle style) {
        ...
        selectionStyle.setOption(TextStyle.Option.INVERSE, !selectionStyle.hasOption(TextStyle.Option.INVERSE));
    ...
    private void updateScrolling(boolean forceUpdate) {
        ...
        if (myScrollingEnabled) {
            ...
            if (value == 0) {
                ...
                // if scrolled to a specific field, update scroll to keep showing this field
