...
public class NearWindow extends JInternalFrame {
    ...
    public NearWindow(ObjectMapper objectMapper, NearMeHandler nearMeHandler) {
        ...
        nearMeItems.setVisibleRowCount(Integer.MAX_VALUE);
